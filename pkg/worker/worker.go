/**
  This is not part of the original knqyf263/go-rpmdb project but taken from Zweih/qp.

  While the original project was licensed under MIT, this portion is licenced under GPTv3-only.
*/
